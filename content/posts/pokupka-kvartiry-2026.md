...
steps:
  - name: "Этап 1: подбор объекта и Due Diligence"
    text: "Юридическая проверка на этапе выбора: выписка из ЕГРН подтверждает личность собственника и отсутствие обременений (залоги, ипотека, аресты); если объект перепродавался несколько раз за последние годы — это повод для более глубокого аудита."
  - name: "Этап 2: предварительный договор и задаток"
    text: "Для закрепления намерений заключается предварительный договор купли-продажи (ПДКП). Если вы внесли задаток и передумали, деньги остаются у продавца; если сделку срывает продавец — он обязан вернуть задаток в двойном размере."
  - name: "Этап 3: основной договор и расчеты"
    text: "Нотариальное удостоверение ДКП строго обязательно, если сделка затрагивает интересы несовершеннолетних или происходит продажа доли в праве общей собственности. Для передачи средств рекомендуется использовать аккредитив или эскроу-счета."
  - name: "Этап 4: государственная регистрация"
    text: "Переход права необходимо зарегистрировать в Росреестре. Процедура обычно занимает от 3 до 9 рабочих дней, после чего вы становитесь полноправным владельцем."
---
